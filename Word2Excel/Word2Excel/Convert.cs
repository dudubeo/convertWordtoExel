...
namespace Word2Excel
{
    public partial class Convert : Form
    {
        ...
        private const string _p_ThongTinDat_MucDichSuDung = @"Đ.t [^:]*:\s*[\d\.]*\s*(m2|n2)";
        ...
        private void btnConvert_Click(object sender, EventArgs e)
        {
            ...
            if (_temdata.Count > 0)
            {
                ...
                foreach (var tempLine in _temdata)
                {
                    ...
                    {
                        if (IsMatch_Pattern(line, out value, _p_ChuSuDung_ChuHo_HoTen2))
                        {
                            // data.ChuSuDung_ChuHo_HoTen = value[0].Value.Substring(value[0].Value.IndexOf(':') + 1).Trim();
                            data.ChuSuDung_ChuHo_HoTen = value[0].Groups["hoten"].Value;
                    ...
                    if (IsMatch_Pattern(line, out value, _p_Loaigiay))
                    {
                    ...
                    if (IsMatch_Pattern(line, out value, _p_socmnd))
                    {
                    ...
                    if (IsMatch_Pattern(line, out value, _p_ChuSuDung_ChuHo_Ngaycap))
                    {
                    ...
                    if (IsMatch_Pattern(line, out value, _p_ChuSuDung_ChuHo_Noicap))
                    {
                    ...
                    {
                        data.GCN_MaVach = value[0].Groups["mavach"].Value.Replace(".", "");
                    }
                    ...
                    if (lst_cn.Count > 1)
                    {
                        ...
                        if (IsMatch_Pattern(line_cn, out value, _p_chuyennhuong))
                        {
                            ...
                            if (IsMatch_Pattern(line, out value, _p_socmnd))
                            {
                                ...
                                if (value[0].Value.Contains("CCCD"))
                                {
                                    data.ChuyenNhuong_VoChong_SoGiayTo = "CCCD";
                                }
                                if (value.Count > 1)
                                {
                            ...
                            if (IsMatch_Pattern(line, out value, _p_ChuSuDung_ChuHo_Ngaycap))
                            {
                                ...
                                if (value.Count > 1)
                                {
                                    data.ChuyenNhuong_ChuHo_NgayCap = value[1].Groups["ngaycap"].Value;
                                }
                            }

                            if (IsMatch_Pattern(line, out value, _p_ChuSuDung_ChuHo_Noicap))
                            {
                                data.ChuyenNhuong_VoChong_NgayCap = value[0].Groups["noicap"].Value;
                                if (value.Count > 1)
                                {
                                    data.ChuyenNhuong_VoChong_NgayCap = value[1].Groups["noicap"].Value;
                                }
                            }
